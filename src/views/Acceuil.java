...
import controllers.CentreDeDonDeSangController;
...
public class Acceuil {
	...
	public Acceuil() {
		...
		imageLabel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(Color.WHITE),
				BorderFactory.createEmptyBorder(0, 10, 10, 10))); // Add border radius
		...
		JPanel centrePanel = new JPanel(new BorderLayout()); // Create a new panel for the centre content

		// Create an instance of CentreDeDonDeSangModel and CentreDeDonDeSangController
		CentreDeDonDeSangModel centreModel = new CentreDeDonDeSangModel();
		CentreDeDonDeSangController centreController = new CentreDeDonDeSangController(centreModel,
	    new CentreDeDonDeSangView());
