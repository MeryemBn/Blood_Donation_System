...
public class AddDonationsView extends JFrame {
	...
	public AddDonationsView() {
		...
		DonorsNamesComboBox = new JComboBox<>(DonationsListModel.getAllDonorNames());
		DonorsNamesComboBox.setFont(new Font("Arial", Font.PLAIN, 16));
		DonorsNamesComboBox.setBackground(Color.WHITE);
		DonorsNamesComboBox.setForeground(Color.BLACK);
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(AddDonationsView::new);
	}

	public JComboBox<String> getDonorsNamesComboBox() {
		return DonorsNamesComboBox;
	}

	public void setDonorsNamesComboBox(JComboBox<String> donorsNamesComboBox) {
		DonorsNamesComboBox = donorsNamesComboBox;
	}
